...
Weibian is a software for taking scientific notes in the spirit of #link("https://www.forester-notes.org/index/index.xml")[Forester], using #link("https://github.com/typst/typst")[Typst] as the markup language.

#footnote[Weibian (simplified Chinese: 韦编; traditional Chinese: 韋編; Chinese Pinyin: wéi biān; IPA: \[weɪ˧˥ pjɛn˥˥\]; roughly “Way-Byen”) means the ancient Chinese technology of bookmaking. Before the invention of paper, Chinese scholars wrote on narrow vertical slips of bamboo or wood (simplified Chinese: 简牍; traditional Chinese: 簡牘) which were then bound together with leather straps to form a book. “韦” (weí) refers to the leather straps used to bind the bamboo slips, and “编” (biān) means to weave, bind, organize or compile. 
...
#tr("wb:20250817T222638")

#tr("wb:20250819T221255")

#tr("wb:20250819T221329")
