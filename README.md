...
By default, Weibian reads Typst sources from `typ/`, uses `.wb/cache` for intermediate HTML, copies assets from `public/`, and outputs the final site to `dist/`. Override paths if needed:
